...
/*
 Projeto Integrador: Desenvolvimento de lógica de programação
 */
/**
 * Autores: Alexsandro da Silva Ramos
...
public class SafeSaga {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out
                            .println("Elas facilitam a sua vida no jogo ela só pode ser utilizada a quantidade\n"
                    ...
                    System.out.println(
                            "Se não souber a alternativa correta passe para próxima pergunta, essa atual será anulada.");
                    System.out.println();
    ...
    static int primeiraEscolha() {
        ...
        System.out.println("Ao sair tarde do trabalho (Por volta das 22h00), você lembra que precisava "
                ...
                + "do vendedor. (Vamos fazer o teste de sorte para ver se consegue um desconto na mà­dia).\n "
    ...
    static int inicioQuiz() {
        ...
        System.out.println(
                ...
                + " Acredito que você não tenha nenhuma habilidade especial para passar pelo meu quiz da Redenção  isso poderia estragar meus planos"
    ...
    static int decisao2() {
        limpaTela();
        System.out.println(
                "Ao sair mais cedo do trabalho, você vai correndo comprar seu lanche no Mc2000. Chegando lá, você vão que a fila enorme "
                + "por conta do horário. Bom, você resolve esperar pacientemente para ser atendido. Neste meio perà­odo, você percebe é uma bela garota/garoto "
    ...
    public static void decisao2Escolha1() {
        ...
        System.out.println(
                ...
                + "é super simples e leve de ser usado em qualquer máquina. Você não vão problema algum, afinal, isso tudo estava acontecendo dentro de uma "
    ...
    public static void decisao2Escolha2() {
        ...
        System.out.println(
                ...
                + "Você fica muito feliz com a atitude dela/dele e lembra de que de fato queria trocar seu provedor. Você não vão problema algum, afinal, isso "
    ...
    static int decisao3() {
        limpaTela();
        System.out.println("Você sai do serviço à s 18:00 e vai com seus amigos"
    ...
    public static void decisao3Escolha1() {
        ...
        System.out.println(" Você pega o CD e nem comenta para seus amigos sobre"
                ...
                + " um jogo que por coincidãoncia você estava louco para comprar."
                ...
                + " como está no perà­odo de avaliação. O hacker pensou e decidiu"
    ...
    public static void decisao3Escolha2() {
        ...
        System.out.println(" Você decide não pegar o CD, usa o banheiro e retorna"
                ...
                + " decide ficar com a mà­dia.Na sua casa você já vai para o seu"
                + " computador e vai ler o CD encontrado e logo é iniciado um"
                + " programa de instalação de um jogo que por coincidãoncia você"
                + " estava louco para comprar. A instalação do jogo fluà­"
                ...
                + " perà­odo de avaliação. O hacker pensou e teve dó de você e"
    ...
    public static void decisao4Escolha1() {
        ...
        System.out.println(" Na loja de games você nota que o preço do jogo"
                ...
                + "Chegando na sua casa você corre para ver o conteúdo da mà­dia e"
                + " logo percebe que se trata-se de um jogo. E logo o jogo que"
                + " você queria comprar, ansioso você nem pensa duas vezes para"
                + " instala-lo. A instalação do jogo fluà­ normalmente e no final"
                ...
                + "pode ser mandado embora como está no perà­odo de avaliação. "
    ...
    public static void decisao4Escolha2() {
        ...
        System.out.println("Você foi direto para a sua casa e decide logo jantar "
                ...
                + " ver o conteúdo da mà­dia no seu PC. De imediato foi executado "
                ...
                + "embora como está no perà­odo de experiãoncia."
                + " O hacker pensou e teve dó de você e decidiu propor um desafio"
                + " para liberar o seu computador. ");
    }
    ...
    public static int pergunta2() {
        ...
        System.out.println("Para que você possa ter alguma chance, vai uma questão fácil"
                + " para você responder. Qual o princà­pio básico de Segurança\n"
    ...
    public static int pergunta7() {
        ...
        System.out.println("Estou com tanta pena de você que vou entrar uma questão \n"
                ...
                + " letras minúscula e maiúsculas e os caracteres #$ é considerada difà­cil.");
    ...
    public static int pergunta8() {
        ...
        alternativas.add("Para que se torne ativo e dão continuidade ao processo de \n"
                + "infecção, o vários depende da execução do programa ou arquivo \n"
                + "hospedeiro, ou seja, para que o computador seja infectado, é \n"
                + "preciso que um programa já infectado seja executado. Pen-drives \n"
                + "e e-mails são meios de propagação de vários."); // resposta correta
        alternativas.add("O vírus de computador consegue viver sozinho, não sendo \n"
                + "necessário nenhum programa hospedeiro.");
        alternativas.add("Para que um vários comece a atuar no computador da vítima,\n"
        ...
        alternativas.add("O sistema operacional Windows 10 é imune a vários de \n"
                + " vírus computador, não sendo necessária a utilização de antivírus.");
        ...
        System.out.println("Vírus é um programa ou parte de um programa de computador,\n"
                ...
                + " Sobre vários, assinale a alternativa correta.");
        ...
        switch (opcao) {
            case 1:
                if (alternativas.get(0)
                        .equals("Para que se torne ativo e dão continuidade ao processo de \n"
                                + "infecção, o vírus depende da execução do programa ou arquivo \n"
                                + "hospedeiro, ou seja, para que o computador seja infectado, é \n"
                                + "preciso que um programa já infectado seja executado. Pen-drives \n"
                                + "e e-mails são meios de propagação de vários.")) {
            ...
            case 5:
                if (alternativas.get(3)
                        .equals("Para que se torne ativo e tenha continuidade ao processo de \n"
                                + "infecção, o vírus depende da execução do programa ou arquivo \n"
                                + "hospedeiro, ou seja, para que o computador seja infectado, é \n"
                                + "preciso que um programa já infectado seja executado. Pen-drives \n"
                                + "e e-mails são meios de propagação de vários.")) {
    ...
    public static int pergunta9() {
        ...
        System.out.println("O conjunto de procedimentos e ações que são utilizados para\n"
                ...
                + " contatos falsos sem o uso da força, do arrombamento fà­sico ou de \n"
    ...
    public static int pergunta10() {
        ...
        System.out.println("As tentativas de engenharia social podem ser evitadas por meio de\n"
                + " medidas simples, como, p2"
                + "or exemplo, não fornecer quaisquer informações \n"
    ...
    public static int pergunta11() {
        ...
        alternativas.add("Um dispositivo constituà­do pela combinação de software e hardware, "
        ...
        alternativas.add("Um dos métodos mais utilizado na internet para compartilhamento "
                + "de informações e troca de mensagens instantà¢neas com seus amigos e familiares.");
    ...
    public static int pergunta13() {
        ...
        alternativas.add("O golpe de phishing consiste em enviar aos usuários uma mensagem legà­tima,"
                + " que é interceptada durante a transmissão, a fim de identificar falhas de segurança e resolvão-las.");
        alternativas.add("O phishing consiste em enviar aos usuários uma mensagem ilegà­tima que aparenta " // correta
        ...
        switch (opcao) {
            case 1:
                if (alternativas.get(0)
                        .equals("O phishing consiste em enviar aos usuários uma mensagem ilegà­tima que aparenta "
                                + "pertencer a uma instituição conhecida, como um banco ou órgãos do governo, com links para "
                                + "páginas falsas que pedem nossos dados (CPF, senhas, etc).")) {
    ...
    public static int pergunta14() {
        ...
        System.out.println("Analise o diálogo apresentado a seguir:\n"
                + "â€”Sr. José, bom dia: aqui fala o suporte técnico do seu provedor de internet. O Sr. está feliz com "
                + "nosso atendimento?\n" + "â€”Sim, bastante\n"
                + "â€”Sr. José constamos uma ligeira redução da velocidade da sua conexão e por isso gostarà­amos"
                + " de confirmar alguns dados para poder estar melhorando o serviço que lhe prestamos. à‰ possà­vel?\n"
                + "â€”Pois não!\n" + "â€”O seu endereço é na rua Bastião, 37?\n" + "â€”Sim\n"
                + "â€”O seu e-mail -e jose.arrose@empresa.com.br?\n" + "â€”Sim\n"
                + "â€”Muito obrigado, Sr José seus dados foram confirmados e podemos continuar nossa entrevista. "
                + "O seu histórico de cliente bom pagador gerou um benefà­cio. A sua velocidade de conexão "
                + "será aumentada sem qualquer acréscimo na sua mensalidade. Bons clientes, melhores "
                + "serviços. O senhor aceita esse prãomio por bom relacionamento?\n" + "â€”Sim\n"
                ...
                + "â€”O senhor, então, pode ditar sua senha de acesso por favor?\n" + "â€”4 5 2 8 4 7 9 3\n"
                + "â€”Muito obrigado, Sr. José. Aguarde uns 30 minutos e verifique como estará mais rápido a sua navegação. "
    ...
    public static int pergunta16() {
        ...
        System.out.println("Larissa recebeu em seu smartphone uma mensagem de texto supostamente "
                + "enviada pelo banco em que possui conta corrente, idãontica à  da imagem a seguir: "
                ...
                + "sendo solicitados, como: agãoncia, conta, senha e demais dados confidenciais. No dia seguinte, "
                ...
                switch (vetor[opcaoHabilidade]) {
                    ...
                    case 3:
                        ...
                        System.out.println("1-) característica relacionada ao fornecimen"
                                ...
                                + "sistemas ou processos para a tomada de decisões dos " + "gestores.");
                        System.out.println("2-) Certeza absoluta de que uma informação "
                                + "provém das fontes anunciadas e não foi modificada ao " + "longo do processo.");
                        System.out.println("Qual Alternativa correta?");
                        resposta = entrada.nextInt();
                        if (resposta == 2) {
                            return 1;
            ...
            case 5:
                ...
                switch (vetor[opcaoHabilidade]) {
                    ...
                    case 3:
                        ...
                        System.out.println("1-) Verifica se uma entidade é realmente o " + "que diz ser.");
                    ...
                    case 4:
                        System.out.println("a resposta correta é:");
                        System.out.println("Verifica se uma entidade é realmente o " + "que diz ser.");
                        return 1;
                }
                vetor[opcaoHabilidade] = 0;
        }
            ...
            case 5:
                ...
                switch (vetor[opcaoHabilidade]) {
                    ...
                    case 3:
                        ...
                        System.out.println(
                                "1-) Senha com oito caracteres (letras maiúsc" + "ulas, minúscula e caracteres especiais)");
            ...
            case 5:
                ...
                switch (vetor[opcaoHabilidade]) {
                    ...
                    case 3:
                        ...
                        System.out.println("1-) Para que se torne ativo e dão continuidade ao processo de \n"
                                + "infecção, o vários depende da execução do programa ou arquivo \n"
                                + "hospedeiro, ou seja, para que o computador seja infectado, é \n"
                                + "preciso que um programa já infectado seja executado. Pen-drives \n"
                                + "e e-mails são meios de propagação de vários.");
                        System.out.println("2-)O vários de computador consegue viver "
                                + "sozinho, não sendo necessário nenhum programa " + "hospedeiro.");
                        System.out.println("Qual Alternativa correta?");
                        resposta = entrada.nextInt();
                        if (resposta == 1) {
                            return 1;
                    ...
                    case 4:
                        System.out.println("a resposta correta é:");
                        System.out.println("Para que se torne ativo e dão continuidade ao processo de \n"
                                + "infecção, o vários depende da execução do programa ou arquivo \n"
                                + "hospedeiro, ou seja, para que o computador seja infectado, é \n"
                                + "preciso que um programa já infectado seja executado. Pen-drives \n"
                                + "e e-mails são meios de propagação de vários.");
            ...
            case 5:
                ...
                switch (vetor[opcaoHabilidade]) {
                    ...
                    case 3:
                        ...
                        System.out.println("1-) O phishing é uma vulnerabilidade do " + "sistema operacional Windows 10.");
                        System.out.println("2-) O phishing consiste em enviar aos usuários "
                                + "uma mensagem ilegà­tima que aparenta pertencer a uma "
                                + "instituição conhecida, como um banco ou órgãos do "
                                + "governo, com links para páginas falsas que pedem " + "nossos dados (CPF, senhas, etc).");
                        System.out.println("Qual Alternativa correta?");
                        resposta = entrada.nextInt();
                        if (resposta == 2) {
                            return 1;
